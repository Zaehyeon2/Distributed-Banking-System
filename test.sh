...
curl --location --request DELETE 'localhost:2221/raft/node_3'
...
curl --location --request POST 'localhost:2221/bank' \
--header 'Content-Type: application/json' \
--data-raw '{
        "account": "account1", 
        "amount": 100
...
curl --location --request GET 'localhost:2221/bank/account1'
...
curl --location --request GET 'localhost:2221/bank/account123'
